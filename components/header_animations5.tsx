              ...
              <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.98 }} className="flex items-center gap-1">
                <Link
                  ...
                  className={cn(
                    ...
                    pathname === item.href ? "text-indigo-600" : "text-gray-800 hover:text-indigo-600 hover:bg-indigo-50"
                  )}
                >
                  {item.name}
                </Link>
                      ...
                      <motion.div key={subItem.href} variants={{ hidden: { opacity: 0, x: -10 }, visible: { opacity: 1, x: 0 } }}>
                        <Link
                          ...
                          className={cn(
                            ...
                            pathname === subItem.href ? "text-indigo-600 font-semibold" : "text-gray-700 hover:bg-indigo-50 hover:text-indigo-600"
                          )}
                        >
                          {subItem.name}
                        </Link>
