              ...
              <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.98 }} className="flex items-center gap-1">
                <Link
                  ...
                  className={cn(
                    ...
                    pathname === item.href ? "text-orange-600" : "text-orange-600 hover:text-blue-600 hover:bg-orange-50"
                  )}
                >
                  {item.name}
                </Link>
                      ...
                      <motion.div key={subItem.href} variants={{ hidden: { opacity: 0, x: -10 }, visible: { opacity: 1, x: 0 } }}>
                        <Link
                          ...
                          className={cn(
                            ...
                            pathname === subItem.href ? "text-orange-600 font-semibold" : "text-gray-700 hover:bg-orange-50 hover:text-blue-600"
                          )}
                        >
                          {subItem.name}
                        </Link>
