      ...
      <div className="container mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <nav className="hidden md:flex items-center gap-4">
          {MENU_ITEMS.map((item) => (
            ...
            >
              <div className="flex items-center gap-1 font-medium text-base text-gray-900 hover:text-[#f36f36] transition-colors">
                  ...
                  >
                    {item.subItems.map(sub => (
                      <Link
                        ...
                        href={sub.href}
                        className={cn(
                          "block px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-100 hover:text-[#f36f36]",
