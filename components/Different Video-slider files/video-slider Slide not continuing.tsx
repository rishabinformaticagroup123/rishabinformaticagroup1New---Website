...
const VideoSlider = () => {
  ...
  const slides: Slide[] = [
    { type: 'short-video', src: "/videos/video1.mp4", duration: 3000 },
    { type: 'short-video', src: "/videos/video2.mp4", duration: 3000 },
    { type: 'short-video', src: "/videos/video3.mp4", duration: 3000 },
    { type: 'youtube', videoId: "4DfifZbfk7w" },
    { type: 'youtube', videoId: "Kg86_3njK6A" }
  ];
  ...
  useEffect(() => {
    ...
    if (current.type === 'short-video' && !isPlaying) {
        ...
        >
          {slide.type === 'short-video' ? (
            ...
            <YouTube
              ...
              opts={opts}
              onStateChange={(e) => {
                if (e.data === 1) handleVideoPlay();  // Playing
