    ...
    <div className="max-w-6xl mx-auto px-4 py-10">
      ...
      <div className="flex justify-center mb-6">
        <input
          ...
          className="w-full max-w-xl px-4 py-2 border rounded-md shadow-sm"
        />
      </div>
      ...
      {filteredData.length === 0 ? (
        <p className="text-center text-red-600 text-lg font-semibold mb-20">❌ No results found. Try a different keyword or category.</p>
      ) : (
        <>
          {/* First 4 Q&A */}
