...
<div className="hidden lg:grid grid-cols-1 lg:grid-cols-2 gap-6">
  <div className="flex flex-col justify-center space-y-4">
    <h1 className="text-4xl sm:text-5xl font-extrabold tracking-tight leading-tight text-gray-800">
      🚀 <span className="text-primary">Kickstart</span> Your Software Career <br />
      in <span className="text-green-600">45 Days</span> with our 
      <span className="text-primary"> COMBO Courses</span> 🎯
    </h1>
