...
import { 
  ...
  Home, Briefcase, Umbrella, Compass,
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><button className="text-gray-400 hover:text-white">IndiGo</button></li>
                <li><button className="text-gray-400 hover:text-white">Air India</button></li>
                <li><button className="text-gray-400 hover:text-white">Vistara</button></li>
                <li><button className="text-gray-400 hover:text-white">SpiceJet</button></li>
                <li><button className="text-gray-400 hover:text-white">AirAsia</button></li>
              </ul>
            </div>
