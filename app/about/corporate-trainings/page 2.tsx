...
const engagements = [
  ...
  },
  {
    ...
    images: [
      "/corporate-training/trichy-1.jpg",
      "/corporate-training/trichy-2.jpg",
      "/corporate-training/trichy-3.jpg",
    ],
  },
];
...
const stats = [
  ...
  { value: "20+", label: "Technology Areas" },
    ...
    <main className="min-h-screen bg-white text-slate-900">
      ...
      <section className="relative overflow-hidden bg-slate-950">
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-20 lg:px-8 lg:py-28">
          <div className="max-w-2xl lg:pr-[48%]">
          ...
          <div className="mt-10 grid grid-cols-3 gap-3 lg:absolute lg:right-8 lg:top-24 lg:mt-0 lg:w-[46%]">
            {[
              "/corporate-training/hyderabad-1.jpg",
              "/corporate-training/hyderabad-2.jpg",
              "/corporate-training/hyderabad-3.jpg",
            ].map((image, index) => (
              <div
                key={image}
                className="relative h-40 overflow-hidden rounded-2xl border border-white/10 shadow-2xl sm:h-52 lg:h-64"
              >
                <Image
                  src={image}
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 lg:px-8 lg:py-20">
        <div className="max-w-3xl">
          ...
          <h2 className="mt-3 text-3xl font-black tracking-tight sm:text-4xl">
            Real training. Real classrooms. Practical learning.
          </h2>
          <p className="mt-4 text-lg leading-8 text-slate-600">
            A glimpse of our instructor-led technical training sessions,
            computer-lab programs and interactive learning environments.
          </p>
        </div>
            ...
            >
              <div className="grid lg:grid-cols-[0.85fr_1.15fr]">
                <div className="flex flex-col justify-center p-7 sm:p-9 lg:p-10">
                  <div className="inline-flex w-fit rounded-full bg-blue-50 px-3 py-1 text-xs font-extrabold uppercase tracking-wider text-blue-700">
                    {engagement.category}
                  </div>
                ...
                {/* ALL 3 PHOTOS SAME MEDIUM SIZE */}
                <div className="grid grid-cols-3 gap-3 bg-slate-100 p-3">
                  {engagement.images.map((image, index) => (
                    ...
                    >
                      <Image
                        src={image}
                        alt={`${engagement.institution} training session ${index + 1}`}
                        fill
