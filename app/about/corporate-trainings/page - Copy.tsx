            ...
            >
              <div className="grid lg:grid-cols-[0.8fr_1.2fr]">
                <div className="p-7 sm:p-9 lg:p-10">
                  <div className="inline-flex rounded-full bg-blue-50 px-3 py-1 text-xs font-extrabold uppercase tracking-wider text-blue-700">
                    {engagement.category}
                  </div>
                ...
                <div className="grid grid-cols-2 gap-2 bg-slate-100 p-2 sm:grid-cols-3">
                  {engagement.images.map((image, index) => (
                    <div
                      key={image}
                      className={`relative min-h-[190px] overflow-hidden rounded-2xl ${
