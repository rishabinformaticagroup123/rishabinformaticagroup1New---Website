// app/api/student-connect/route.ts - FINAL CORRECTED VERSION
import { NextRequest, NextResponse } from 'next/server';
import { testSnowflakeConnection } from '@/lib/snowflake'; // ← Use the ALIAS!
...
export async function POST(request: NextRequest) {
  try {
    ...
    // Test connection first - Use the ALIAS name
    ...
    // Setup student workspace (creates schema, tables, sample data)
    ...
    console.error('❌ Student connect API error:', error);
