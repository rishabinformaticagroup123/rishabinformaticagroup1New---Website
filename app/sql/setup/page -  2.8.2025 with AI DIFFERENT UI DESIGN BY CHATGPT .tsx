...
export default function SQLLab() {
  ...
  const [mode, setMode] = useState<'sql' | 'fix' | 'chat'>('sql') // AI Mode
  ...
  const runQuery = async () => {
    ...
    try {
      ...
      if (['truncate', 'drop', 'delete'].includes(action)) {
        if (tableName) {
    ...
    <div className="min-h-screen bg-gray-100 text-gray-800 font-sans flex flex-col">
      ...
      <div className="flex flex-1 overflow-hidden h-[calc(100vh-48px)]">
        ...
        <div className="flex-grow flex-shrink-0 basis-4/5 flex flex-col">
          {/* Editor Panel */}
          <div ref={topPanelRef} className="flex-grow basis-1/2 bg-white p-4 flex flex-col border-b border-gray-300">
            ...
            <div className="mt-4 flex justify-between items-center">
              <div className="flex gap-2">
                ...
                {mode === 'fix' && (
                  <Button onClick={handleFix} disabled={aiLoading}>
          ...
          {/* Results Panel */}
          <div className="flex-grow basis-1/2 bg-white p-4 overflow-auto">
            {loading ? (
