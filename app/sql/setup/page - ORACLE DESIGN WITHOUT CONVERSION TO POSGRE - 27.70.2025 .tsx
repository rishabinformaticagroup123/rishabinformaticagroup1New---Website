...
export default function SQLLab() {
  ...
  <div className="flex items-center justify-between px-4 py-2 bg-blue-800 text-white">
   {/* Empty div to push heading to right */}
  <div></div>
    {/* Add this new heading */}
  <h1 className="text-lg font-bold">        SQL Lab + Practice , Master SQL Injust One week </h1>
  
  {/* Keep the existing mode switch (just move it to the right) */}
