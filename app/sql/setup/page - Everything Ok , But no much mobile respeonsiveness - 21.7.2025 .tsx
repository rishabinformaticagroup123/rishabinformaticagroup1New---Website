...
export default function SQLPracticeLab() {
  ...
  return (
    <div className="min-h-screen bg-blue-900 text-white flex">
      {/* Sidebar */}
      <aside className="w-64 bg-blue-800 p-4 border-r border-blue-600">
        <h2 className="text-lg font-semibold mb-2">Tables</h2>
        <ul>
          {tables.map((table) => (
            <li
              key={table}
              className="cursor-pointer hover:text-yellow-300 mb-1"
      ...
      <main className="flex-1 p-6">
        <div className="max-w-5xl mx-auto">
          <h1 className="text-3xl font-bold mb-4">SQL Lab + Practice</h1>
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <label className="flex items-center gap-2">
              ...
              />
              <span>Oracle Syntax(Oracle Cloud, On-Premise, etc)</span>
            </label>
          </div>
