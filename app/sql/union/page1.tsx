...
// Reusing the SqlCodeBlock component from your RankFunctionsPage
...
const UnionFunctionsPage = () => {
  ...
  Country VARCHAR2(20)
      ...
      <SqlCodeBlock code={`-- Data for Stud_union_A
INSERT INTO Stud_union_A VALUES (100, 'Rishab', 1212121212, 'Brazil');
INSERT INTO Stud_union_A VALUES (101, 'Naresh', 1414141414, 'Canada');
INSERT INTO Stud_union_A VALUES (102, 'Hari', 9448005273, 'India');
INSERT INTO Stud_union_A VALUES (103, 'Deva', 7878707878, 'Germany');
INSERT INTO Stud_union_A VALUES (104, 'Hemanth', 1313131313, 'Denmark');
INSERT INTO Stud_union_A VALUES (100, 'Rishab', 1212121212, 'Brazil'); -- Duplicate
`} />
      <SqlCodeBlock code={`-- Data for Stud_union_B
INSERT INTO Stud_union_B VALUES (100, 'Rishab', 1212121212, 'Brazil'); -- Duplicate
INSERT INTO Stud_union_B VALUES (101, 'Naresh', 1414141414, 'Canada'); -- Duplicate
INSERT INTO Stud_union_B VALUES (105, 'Sonakshi', 9112324567, 'India');
INSERT INTO Stud_union_B VALUES (106, 'Mahesh', 2323232323, 'India');
INSERT INTO Stud_union_B VALUES (104, 'Hemanth', 1313131313, 'Denmark'); -- Duplicate
`} />
...
SELECT * FROM Stud_union_B;`} />
      <Paper elevation={3} sx={{ p: 2, mb: 3, bgcolor: '#e8f5e9' }}>
        <Typography variant="body2" fontWeight="bold" color="success.dark">
          Expected SQL Output (Distinct Rows):
        </Typography>
        <Box component="pre" sx={{ bgcolor: '#e8f5e9', p: 1, borderRadius: 1, fontSize: '0.9rem', overflowX: 'auto' }}>
          {`STUD_ID | STUD_NAME | MOBILE_NO  | COUNTRY
------------------------------------------------
...
SELECT * FROM Stud_union_B;`} />
      <Paper elevation={3} sx={{ p: 2, mb: 3, bgcolor: '#e3f2fd' }}>
        <Typography variant="body2" fontWeight="bold" color="info.dark">
          Expected SQL Output (All Rows, including Duplicates):
        </Typography>
        <Box component="pre" sx={{ bgcolor: '#e3f2fd', p: 1, borderRadius: 1, fontSize: '0.9rem', overflowX: 'auto' }}>
          {`STUD_ID | STUD_NAME | MOBILE_NO  | COUNTRY
------------------------------------------------
100     | Rishab    | 1212121212 | Brazil
101     | Naresh    | 1414141414 | Canada
...
INTERSECT
SELECT * FROM Stud_union_B;`} />
      <Paper elevation={3} sx={{ p: 2, mb: 3, bgcolor: '#fff3e0' }}>
        <Typography variant="body2" fontWeight="bold" color="warning.dark">
          Expected SQL Output (Common Rows):
        </Typography>
        <Box component="pre" sx={{ bgcolor: '#fff3e0', p: 1, borderRadius: 1, fontSize: '0.9rem', overflowX: 'auto' }}>
          {`STUD_ID | STUD_NAME | MOBILE_NO  | COUNTRY
------------------------------------------------
100     | Rishab    | 1212121212 | Brazil
101     | Naresh    | 1414141414 | Canada
...
SELECT * FROM Stud_union_B;`} />
      <Paper elevation={3} sx={{ p: 2, mb: 3, bgcolor: '#ffebee' }}>
        <Typography variant="body2" fontWeight="bold" color="error.dark">
          Expected SQL Output (Rows in A but not in B):
        </Typography>
        <Box component="pre" sx={{ bgcolor: '#ffebee', p: 1, borderRadius: 1, fontSize: '0.9rem', overflowX: 'auto' }}>
          {`STUD_ID | STUD_NAME | MOBILE_NO  | COUNTRY
------------------------------------------------
102     | Hari      | 9448005273 | India
103     | Deva      | 7878707878 | Germany`}
...
SELECT * FROM Stud_union_A;`} />
      <Paper elevation={3} sx={{ p: 2, mb: 3, bgcolor: '#ffebee' }}>
        <Typography variant="body2" fontWeight="bold" color="error.dark">
          Expected SQL Output (Rows in B but not in A):
        </Typography>
        <Box component="pre" sx={{ bgcolor: '#ffebee', p: 1, borderRadius: 1, fontSize: '0.9rem', overflowX: 'auto' }}>
          {`STUD_ID | STUD_NAME | MOBILE_NO  | COUNTRY
------------------------------------------------
...
export default UnionFunctionsPage;
