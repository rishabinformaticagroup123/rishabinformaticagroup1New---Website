        ...
        <section className="container mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-12">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
            ...
            <div className="flex flex-col justify-center">
              ...
              {/* Students Work At Text (Left Side) */}
              <div className="mt-12">
            ...
            {/* Right Column - Now Contains BOTH Video and Animation */}
            <div className="flex flex-col items-center justify-center pt-8 gap-8"> {/* Added gap between video and animation */}
              {/* Video (Moved slightly up with pt-8) */}
              ...
              {/* Animation Container (Flows from right to left) */}
              <div className="w-full overflow-hidden">
                <CompanySlider direction="right-to-left" /> {/* Pass direction prop to your slider */}
              </div>
            </div>
          </div>
        </section>
