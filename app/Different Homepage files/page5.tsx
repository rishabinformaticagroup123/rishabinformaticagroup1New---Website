...
<div className="flex flex-col gap-0 pb-16">
  ...
  <div className="bg-gradient-to-r from-primary/10 via-primary/5 to-background">
    <section className="container mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-4"> {/* Reduced pb-12 to pb-4 */}
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
        ...
        <div className="flex flex-col justify-center">
          ...
          <p className="mt-4 max-w-xl text-muted-foreground">
            Rishab Informatica Group offers industry-leading courses...
          </p>
          ...
          <div className="mt-8 mb-4">
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Graduates have been placed at top companies worldwide.
            </p>
          </div>
        </div>
    ...
    <div className="w-full overflow-hidden bg-white/10 py-4"> {/* Added subtle background */}
      <div className="animate-marquee-left-to-right whitespace-nowrap">
        {[...Array(2)].map((_, i) => ( // Double the logos for seamless loop
          <div key={i} className="inline-flex items-center space-x-12 px-4">
            {['microsoft', 'google', 'amazon', 'oracle', 'ibm', 'tcs'].map((company) => (
