  ...
  return (
    <div className="flex flex-col gap-0 pb-16">
      ...
      <div className="bg-gradient-to-r from-primary/10 via-primary/5 to-background">
        ...
        <section className="container mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-12"> {/* Added pt-8 for header spacing */}
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
            ...
            <div className="flex flex-col justify-center">
              ...
              {/* Moved Students Work At section here */}
              <div className="mt-12">
                <h2 className="text-xl font-bold tracking-tight sm:text-2xl"> {/* Reduced text size */}
            ...
            {/* Right Column - Video with top spacing */}
            <div className="flex items-center justify-center pt-12"> {/* Added pt-12 to move video down */}
