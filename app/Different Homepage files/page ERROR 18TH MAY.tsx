...
export default function Home() {
  return (
    <div className="flex flex-col gap-0 pb-16">import { Button } from "@/components/ui/button"
import { Card, CardContent } from "@/components/ui/card"
import { ArrowRight, BookOpen, CheckCircle, GraduationCap, Users } from "lucide-react"
import Image from "next/image"
import Link from "next/link"
        ...
        <section className="container mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-8">
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
            ...
            <div className="flex flex-col justify-center space-y-6">
              ...
              {/* Alumni Section */}
              <div className="pt-0">
                <h2 className="text-2xl font-bold tracking-tight text-gray-900 mb-0">
...
const courses = [
  ...
  },
  {
    ...
    image: "/courses/performance.jpg", // Fixed image path
    href: "/courses/performance-engineering" // Fixed href
  }
]
