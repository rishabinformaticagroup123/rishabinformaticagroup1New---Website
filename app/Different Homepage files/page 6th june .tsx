...
const stats = [
  ...
  { value: "45 Days", label: "Average Placement Time" },
...
export default function Home() {
  return (
    <div className="flex flex-col gap-0 pb-16">
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 items-start">
            ...
            <div className="flex flex-col justify-center space-y-6">
              <h1 className="text-3xl font-extrabold tracking-tight sm:text-4xl">
                We provide complete guidance to get a software job in just 45 days with our <span className="text-primary">Combo Courses</span>
              </h1>
              
              <Link 
                href="/blog/how-we-help-you-get-job-in-45-days" 
                  ...
                  {companyLogos.map((logo, index) => (
                    <div key={index} className="flex items-center justify-center">
                      <Image 
                        ...
                        width={80}
                        height={40}
                        className="object-contain h-8 grayscale hover:grayscale-0 transition-all"
                      />
                    </div>
                  ))}
                </div>
            ...
            <div className="flex flex-col items-center justify-start mt-4">
              ...
              <div className="mt-6 text-center">
                <p className="text-lg font-medium">Watch free lessons before you enroll</p>
      ...
      <div className="w-full overflow-hidden py-6 bg-white/10 relative">
        {/* Edge fade effects */}
        ...
        <div className="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="group relative overflow-hidden rounded-xl border bg-card shadow-sm transition-all hover:shadow-md">
            ...
            <div className="p-6">
              ...
              <Button asChild className="mt-6 w-full">
                <Link href="/courses/AZURE-Combo-Live">
                  Enroll Now
                </Link>
              </Button>
            </div>
          ...
          <div className="group relative overflow-hidden rounded-xl border bg-card shadow-sm transition-all hover:shadow-md">
            ...
            <div className="p-6">
              ...
              <Button asChild className="mt-6 w-full">
                <Link href="/courses/SNOWFLAKE-Combo-Live">
                  Enroll Now
                </Link>
              </Button>
            </div>
