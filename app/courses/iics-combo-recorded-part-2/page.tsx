      ...
      <section className={styles.hero}>
        <div className={styles.heroContent}>
          <div className={styles.heroText}>
            ...
            <h1>Informatica IICS <span className={styles.highlight}>COMBO</span> FULL COURSE Part-2</h1>
        ...
        <div className={styles.batchCards}>
          <div className={styles.batchCard}>
            ...
            <Button asChild className={styles.enrollButton}>
              <Link href="https://course.rishabinformaticagroup.com/courses/481959" target="_blank">
                Enroll Now
              </Link>
            </Button>
          </div>
