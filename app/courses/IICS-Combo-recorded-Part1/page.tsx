      ...
      <section className={styles.hero}>
        <div className={styles.heroContent}>
          <div className={styles.heroText}>
            ...
            <h1>Informatica IICS <span className={styles.highlight}>COMBO</span> FULL COURSE Part-1</h1>
      ...
      <section className={styles.batchSection} id="enroll">
        ...
        <div className={styles.batchCards}>
          <div className={styles.batchCard}>
            <h3>Recorded course with 24*7 Tech support</h3>
            ...
            <div className={styles.priceTag}>₹2,500 <span className={styles.originalPrice}>₹5,000</span></div>
            <Button asChild className={styles.enrol0lButton}>
              <Link href="https://course.rishabinformaticagroup.com/courses/485949" target="_blank">
                Enroll Now
              </Link>
            </Button>
          </div>
