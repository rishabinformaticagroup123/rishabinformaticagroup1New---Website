        ...
        <Tabs defaultValue="all" className="w-full">
          ...
          <TabsContent value="all" className="mt-0">
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
              {[
                {
                  title: "Informatica IICS COMBO Live",
                  ...
                  price: "$999",
                  href: "/courses/IICS-Combo",
                  category: "informatica",
                },
                {
                  title: "Azure Data Engineering Combo Live",
                ...
                {
                  title: "Snowflake Combo Training Live",
                ...
                {
                  title: "Performance Engineering Live",
                ...
                {
                  title: "Informatica IICS COMBO FULL Course",
                  ...
                  level: "Beginner to Advanced",
                  price: "$699",
                  href: "/courses/informatica IICS COMBO FULL Course",
                  category: "informatica",
                },
                {
				 title: "Informatica Power Center Course",
                ...
                {
                  title: "Informatica IICS CAI Course",
