          ...
          <TabsContent value="all" className="mt-0">
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {ALL_COURSES.map((course, index) => (
                <Card key={course.id} className="overflow-hidden min-w-0">
                  <div className="relative">
                    ...
                    />
                    <div className="absolute right-4 top-1 rounded-full bg-primary px-3 py-1 text-xs font-medium text-primary-foreground">
