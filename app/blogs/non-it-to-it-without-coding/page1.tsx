  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-12 text-gray-800">
      ...
      <h1 className="text-4xl font-bold text-primary mb-3 leading-snug">
        Stuck After Graduation, in a Non-IT Job, or the Wrong IT Role?
      </h1>
      <h2 className="text-2xl font-semibold text-blue-600 mb-6">
        Here's a 45-Day Plan to Transform Your Software Career!
      </h2>

      {/* Highlight Audience */}
      <div className="bg-yellow-100 p-4 rounded-md border-l-4 border-yellow-500 mb-6">
        <p className="text-lg font-semibold text-gray-800">
          This 45-Day Career Plan is designed for:
        </p>
        <ul className="list-disc pl-6 text-gray-700 mt-2 space-y-1">
          <li>🎓 Fresh Graduates who feel unclear about their career path</li>
          <li>🔁 Non-IT professionals planning to transition into IT</li>
          <li>💼 IT professionals who want to switch to high-demand domains like Data Engineering or Cloud</li>
        </ul>
      </div>

      {/* Intro Message */}
      <ul className="list-disc pl-5 space-y-2 text-lg text-muted-foreground mb-6">
        <li>Wondering <strong>“What should I do after my degree?”</strong></li>
        <li>Still stuck in a non-IT job even after trying to move?</li>
        <li>Not growing in your current IT role and looking for something better?</li>
        <li>
          At <span className="font-semibold text-primary">Rishab Informatica Group</span>, we offer 
          <span className="text-green-700 font-bold"> free career guidance</span> and a 
          proven step-by-step learning roadmap to help you succeed in the IT industry.
        </li>
      </ul>
