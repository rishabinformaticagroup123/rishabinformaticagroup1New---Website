...
export const interviewData: QA[] = [
  {
    ...
    answer: (
      <div>
        <p>It’s a data integration tool used to move data from different sources like databases, Csv file, etc., into a target system like a data warehouse. You can clean, modify, and join the data during this movement. Think of it like a delivery service that also checks and repacks your items before sending them.</p>
      </div>
    ),
    category: "Overview"
  },
