    ...
    answer: (
      <div>
        ...
        <div className="bg-blue-50 p-3 rounded-lg border border-blue-200 mt-4">
          ...
          <pre className="text-sm text-blue-800 bg-white p-2 rounded mt-2">
            SELECT department, COUNT(*) FROM employees<br />
            GROUP BY department;
          </pre>
      ...
      <div>
        ...
        <div className="bg-blue-50 p-3 rounded-lg border border-blue-200 mt-4">
          ...
          <pre className="text-sm text-blue-800 bg-white p-2 rounded">
            ...
            CASE<br />
            &nbsp;&nbsp;WHEN Rating >= 4 THEN 'Excellent'<br />
            &nbsp;&nbsp;WHEN Rating = 3 THEN 'Good'<br />
            &nbsp;&nbsp;ELSE 'Needs Improvement'<br />
            END AS PerformanceCategory<br />
            FROM Employees;
          </pre>
    ...
    answer: (
      <div>
        ...
        <div className="bg-blue-50 p-3 rounded-lg border border-blue-200 mt-4">
          ...
          <pre className="text-sm text-blue-800 bg-white p-2 rounded">
            CREATE VIEW EmployeeSalaryView AS<br />
    ...
    answer: (
      <div>
        ...
        <div className="bg-blue-50 p-3 rounded-lg border border-blue-200 mt-4">
          ...
          <pre className="text-sm text-blue-800 bg-white p-2 rounded">
            SELECT DepartmentName FROM Departments d<br />
            WHERE EXISTS (<br />
            &nbsp;&nbsp;SELECT 1 FROM Employees e<br />
    ...
    answer: (
      <div>
        ...
        <div className="bg-blue-50 p-3 rounded-lg border border-blue-200 mt-4">
          ...
          <p>✅ With CTE:</p>
          <pre className="text-sm text-blue-800 bg-white p-2 rounded">
            WITH AverageSalary AS<br />
            (SELECT AVG(Salary) AS AvgSal FROM Employees)<br />
            SELECT Name, Salary<br />
            FROM Employees, AverageSalary<br />
      ...
      <div>
        ...
        <div className="bg-blue-50 p-3 rounded-lg border border-blue-200 mt-4">
          ...
          <pre className="text-sm text-blue-800 bg-white p-2 rounded">
            ...
            LIMIT 10 OFFSET 0; -- Page 1 (rows 1-10)<br /><br />
            SELECT * FROM Employees<br />
            LIMIT 10 OFFSET 10; -- Page 2 (rows 11-20)<br /><br />
            SELECT * FROM Employees<br />
