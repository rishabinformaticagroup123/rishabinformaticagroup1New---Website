...
// Define slide content based on Snowflake + DBT + Apache Airflow training modules
const trainingSlides = [
  // INTRODUCTION
  {
    ...
    content: "A complete 47-day intensive training program covering the modern data stack: Snowflake for cloud data warehousing, DBT for ELT transformations, and Apache Airflow for pipeline orchestration.",
    module: "Introduction",
  ...
  // TRAINING PHILOSOPHY & OVERVIEW
  {
    ...
    content: "At Rishab Informatica Group, we don't just teach tools. We train students to crack interviews, survive real projects, and grow confidently in IT careers.",
    module: "Overview",
  ...
  // SUCCESS FLOW TIMELINE
  {
    ...
    content: "A structured timeline from Day 1 to Day 47 designed to make you job-ready with confidence.",
    module: "Overview",
  ...
  // COURSE OVERVIEW
  {
    ...
    content: "Master the complete modern data engineering stack with 47 comprehensive sessions across three key technologies.",
    module: "Overview",
  ...
  // APACHE AIRFLOW MODULE OVERVIEW
  {
    ...
    content: "Learn the world's most popular pipeline orchestration tool — used by Airbnb, Uber, Netflix & 10,000+ companies globally. 100% FREE, open source, works perfectly with Snowflake and DBT.",
    module: "Airflow",
    icon: <Wind className="h-20 w-20 text-red-600" />,
  ...
  // APACHE AIRFLOW DETAILS
  {
    ...
    module: "Airflow",
    icon: <Terminal className="h-16 w-16 text-red-600" />,
  ...
  // BONUS: WHY AIRFLOW
  {
    ...
    content: "Airflow is used by Airbnb, Uber, Netflix & 10,000+ companies globally. Adding Airflow makes this the most complete and most demanded Modern Data Engineering stack of 2026.",
    module: "Airflow",
    icon: <AlertCircle className="h-20 w-20 text-red-600" />,
...
export default function TrainingPresentation() {
  ...
  const ModuleIcon = ({ module }: { module: string }) => {
    switch (module) {
      ...
      case 'Airflow':
        return <Wind className="h-6 w-6 text-red-600" />;
      default:
        ...
        <div className="flex-1 overflow-y-auto pr-4">
          ...
          {slide.detailedContent && (
            <div className="space-y-6">
              <h3 className="text-xl font-semibold text-gray-800">Curriculum Breakdown:</h3>
                    ...
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center">
                        <div className="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center mr-3">
                          <span className="font-bold text-blue-700 text-xs">{day.day}</span>
                        </div>
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-bold">Snowflake + DBT + Airflow Training</h1>
                <p className="text-sm text-gray-600">Modern Data Engineering — Interactive Presentation</p>
              </div>
            </div>
