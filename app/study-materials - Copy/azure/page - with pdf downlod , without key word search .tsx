...
// ADF Q&A Page with full structure and styled layout
...
Update watermark after successful load.`,
  ...
  // Add 46 more Q&A items here with similar format
];
...
export default function ADFInterviewPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-10">
      {/* 🔹 Heading */}
      <h1 className="text-4xl font-extrabold text-center bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 bg-clip-text text-transparent mb-4">
        ...
        <ol className="space-y-6 list-decimal list-inside text-gray-800">
          {firstFour.map((qa, index) => (
            <li key={index} className="mb-4">
              ...
              <pre className="whitespace-pre-wrap mt-1 text-gray-700">{qa.answer}</pre>
      ...
      <div className="border rounded-lg overflow-hidden mb-12 shadow">
        <h2 className="text-xl font-semibold mb-4">📄 Prefer the full visual version?</h2>
        <iframe
      ...
      <div className="bg-white border rounded-lg p-6 shadow-sm">
        ...
        <ol start={5} className="space-y-6 list-decimal list-inside text-gray-800">
