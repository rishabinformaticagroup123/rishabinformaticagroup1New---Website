          ...
          <div className="lg:hidden flex flex-col gap-4">
            <div className="flex flex-col justify-center space-y-3">
              ...
              <p className="text-base text-muted-foreground">
                Rishab Informatica Group offers industry-leading courses in Informatica IICS Combo, Azure Data Eng. Combo, Snowflake.
              </p>
              ...
              <div className="flex flex-col gap-2 mt-2">
                ...
                <div className="mt-4 flex items-center justify-center gap-2">
                  <a 
                    ...
                    className="flex items-center gap-2 text-base font-semibold text-blue-700 hover:underline"
                  >
