...
const FULL_MENU_ITEMS = [
  // ... (keep your existing menu items array exactly as is) ...
];
          ...
          {PRIORITY_MENU_ITEMS.map((item) => (
            ...
            >
              ...
              {item.subItems && activeDropdown === item.name && (
                <div className="absolute left-0 top-full mt-1 w-56 bg-white dark:bg-card rounded-md shadow-lg z-50 animate-dropdown">
                  <div className="py-1">
